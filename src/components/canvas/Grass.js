...
export function Grass({
  ...
  const [texture, alphaMap, ground] = useLoader(THREE.TextureLoader, [
    '/maps/CustomTerrainShape/Assets/Detail_1/GrassFrond01AlbedoAlpha.png',
    '/maps/CustomTerrainShape/Assets/Detail_1/GrassFrond01AlbedoAlpha.png',
    '/maps/CustomTerrainShape/Assets/Grass_020/ground_Grass1_col.png',
  ])
  ground.wrapS = RepeatWrapping
  ground.wrapT = RepeatWrapping
  ground.repeat = new Vector2(10, 10)
...
function getAttributeData(instances, width) {
  ...
  for (let i = 0; i < instances; i++) {
    ...
    // const _r = i < instances / 2 ? 90 : 30
    const _r = 40
    const radius = Math.sqrt(Math.random()) * _r
    const _x = Math.cos(a) * radius
    const _z = Math.sin(a) * radius
